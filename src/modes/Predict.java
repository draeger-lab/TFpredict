				...
				if (predictionPossible.get(seq)) {
					...
					if (seqIsTF.get(seq)) {
					    ...
					    if (!seq2job.isEmpty() && seq2job.containsKey(seq)) {
							bw.write("<table>\n");
							bw.write("  <tr><th> <img src=\"" + seq2job.get(seq) + ".visual-png.png\"/>" + "</th></tr>\n");	
							bw.write("  <tr><th> Illustration generated by <a href=http://www.ebi.ac.uk/Tools/pfa/iprscan/ target=\"_blank\"> InterProScan </a> </th></tr>\n");
							bw.write("</table>\n\n");
							bw.write("<br>\n\n");
					    }
