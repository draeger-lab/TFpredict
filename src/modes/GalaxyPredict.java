...
public class GalaxyPredict {
	...
	private void runInterproScan() {
		...
		ArrayList<String[]> IPRoutput = IPRrun.run(input_file, iprpath, basedir, useWeb);
		...
		try {
			...
			for (int i=0; i<sequence_ids.length; i++) {
				...
				if (predictionPossible.get(seq)) {
				    ...
				    if (gfxAvailable.get(seq)) {
						bw.write("<h1>Illustration generated by IPRscan</h1>\n");
						bw.write("<table>\n");
						bw.write("  <tr><th> <img src="+basedir+"/"+seq2job+"</th></tr>\n");	
						// TODO Description bw.write("  <tr><th> </th></tr>\n");
						bw.write("</table>\n\n");
						bw.write("<br>\n\n");
				    }
