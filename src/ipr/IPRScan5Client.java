...
/* $Id: IPRScan5Client.java 2754 2014-04-10 14:58:21Z hpm $
 * ======================================================================
 * 
 ...
 * 
 * ======================================================================
 * JDispatcher InterProScan 5 (SOAP) web service Java client using Axis 1.x.
 * ----------------------------------------------------------------------
 * Tested with:
...
import uk.ac.ebi.webservices.axis1.stubs.iprscan5.*;

/**
 * <p>
 * JDispatcher InterProScan 5 (SOAP) web service Java client using Apache Axis
 * 1.x.
 * </p>
 * 
 * <p>
 ...
 * <ul>
 * <li><a
 * href="http://www.ebi.ac.uk/Tools/webservices/services/sss/iprscan5_soap"
 * >http://www.ebi.ac.uk/Tools/webservices/services/sss/iprscan5_soap</a></li>
 * <li><a
 ...
 * </ul>
 */
public class IPRScan5Client extends AbstractWsToolClient {
	/** Service proxy */
	private JDispatcherService_PortType srvProxy = null;
	/** Client version/revision */
	private String revision = "$Revision: 2754 $";
	...
	public String submitJobFromCli(CommandLine cli, String inputSeq)
		...
		if (cli.hasOption("async")) {
			...
			System.err
					.println("To get status: java -jar IPRScan5_Axis1.jar --status --jobid "
							+ jobid);
		}
	...
	public static void main(String[] args) {
		...
		IPRScan5Client client = new IPRScan5Client();
		try {
