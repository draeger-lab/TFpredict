 ...
 * @since 1.0
 */
public class NaiveFeatureGeneratorProk extends BLASTfeatureGeneratorProk {

	/**
	 * A {@link Logger} for this class.
	 */
	private static final transient Logger logger = Logger.getLogger(NaiveFeatureGeneratorProk.class.getName());
	 ...
	 * @param superPred
	 */
	public NaiveFeatureGeneratorProk(String fastaFile, String featureFile, boolean superPred) {
	...
	/* (non-Javadoc)
	 * @see features.BLASTfeatureGeneratorProk#computeFeaturesFromBlastResult(java.lang.String, java.util.Map)
	 */
	@Override
