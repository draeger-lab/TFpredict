 ...
 * @since 1.0
 */
public class PSSMFeatureGeneratorProk extends BLASTfeatureGeneratorProk {
	 ...
	 * @param superPred
	 */
	public PSSMFeatureGeneratorProk(String fastaFile, String featureFile, boolean superPred) {
